...
+ Introduzione {#get-started}
  ...
  + Configurazione dell’ambiente {#admin-setup}
...
+ Funzionalità AI {#ai-assistant}
  ...
  + [Interfaccia chat](./ai-assistant/use-ai-assistant.md)
...
+ Gestione dei percorsi {#journeys}
  ...
  + Nodi del percorso {#journey-nodes}
    ...
    + [Pubblico persona](./journeys/person-audience-nodes.md)
    ...
    + [Percorsi suddivisi variante (Beta)](./journeys/variant-split-paths-nodes.md)
...
+ Account {#accounts}
  ...
  + Elenchi account {#account-lists}
    ...
    + [Uso in percorsi](./accounts/account-lists-journeys.md)
...
+ Gestione dei contenuti {#content-management}
  ...
  + Risorse {#assets}
    ...
    + [Metadati C2PA](./content/c2pa-metadata.md)
  ...
  + Personalizzazione {#personalization}
    ...
    + [Generatore di script (Beta)](./content/script-builder.md)
...
+ Amministrazione {#admin}
  ...
  + [Gestione della privacy](./admin/privacy-management.md)
