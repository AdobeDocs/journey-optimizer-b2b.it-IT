---
user-guide-title: Documentazione di Journey Optimizer B2B Ultimate
user-guide-description: Scopri Adobe Journey Optimizer B2B edition Ultimate e come utilizzarlo per orchestrare account e percorsi di gruppi di acquisto utilizzando l’intelligenza artificiale generativa integrata e l’automazione leader di settore.
...
# Guida utente di Journey Optimizer B2B Ultimate {#user}

+ [Documentazione di Adobe Journey Optimizer B2B Ultimate](guide-overview.md)
...
+ Introduzione {#get-started}
   ...
   + Configurazione di Ultimate {#ultimate}
      + [Elenco di controllo per l’installazione](./setup-ultimate.md)
   ...
   + [Onboarding degli utenti](./start/get-started.md)
...
+ Gestione dei percorsi {#journeys}
   ...
   + Nodi del percorso {#journey-nodes}
      ...
      + [Prossimo percorso migliore](./journeys/next-best-path-node.md)
...
+ Account {#accounts}
   + Gruppi acquisti {#buying-groups}
      ...
      + [Informazioni in-CRM](./buying-groups/incrm-insights.md)
...
+ Gestione dei contenuti {#content-management}
   ...
   + Risorse {#assets}
      ...
      + Risorse interne {#internal-dam}
         + [Utilizzare risorse interne](./content/internal-image-assets.md)
...
+ Dashboard intelligenti {#dashboards}
   ...
   + [Rapporto sulle prestazioni delle e-mail](./dashboards/email-performance-dashboard.md)
   + [Dashboard dei gruppi di acquisto](./dashboards/buying-groups-dashboard.md)
   + [dashboard percorsi](./dashboards/journeys-dashboard.md)
