...
>&gt; <li>Schema di riferimento: [Account B2B - Schema account aziendale XDM](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/schemas/create-schemas-for-b2b-data)
