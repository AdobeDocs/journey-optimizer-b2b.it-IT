---
title: Account Qualification Agent per B2B
description: Scopri Account Qualification Agent basato sull’intelligenza artificiale per i team di vendita B2B per accelerare la generazione di pipeline con ricerche di potenziali clienti automatizzate, approfondimenti sull’account e bozze e-mail.
...
# Account Qualification Agent per B2B

>[!AVAILABILITY]
>
>Questa funzione è attualmente a disponibilità limitata e non è disponibile per tutti gli utenti.

Account Qualification Agent è un assistente basato sull’intelligenza artificiale progettato per i rappresentanti dell’account. Semplifica e automatizza i principali flussi di lavoro di sviluppo delle vendite, riducendo in modo significativo il sovraccarico manuale e accelerando la generazione delle pipeline.

![Account Qualification Agent](assets/acc-qualification-agent.png)

Costruita insieme a Adobe Journey Optimizer B2B (AJO B2B) e al framework Adobe Agent Orchestrator, questa soluzione integra in modo intelligente dati, orchestrazione e funzionalità di intelligenza artificiale generative per abilitare i rappresentanti di sviluppo aziendale (BDR) con le seguenti competenze:
...
* **Ricerca account**
  ...
  Effettuare ricerche sull&#39;account utilizzando il recupero automatico e la visualizzazione di informazioni dettagliate sull&#39;organizzazione di un potenziale clienteQueste informazioni includono dati vitali dell&#39;azienda, notizie recenti, priorità strategiche e membri più importanti.
...
Questo sistema di agenti intelligente migliora la scalabilità, mantiene la consapevolezza contestuale tra le interazioni e si integra perfettamente nella toolchain BDR, consentendo ai BDR di concentrarsi su conversazioni di alto valore piuttosto che su attività ripetitive.
