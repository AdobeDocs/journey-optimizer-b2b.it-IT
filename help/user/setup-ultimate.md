...
description: Configurare Journey Optimizer B2B edition. Configura schemi XDM, canali e-mail/SMS, azioni del percorso Marketo Engage e utenti.
...
Adobe Journey Optimizer B2B edition è basato su Adobe Experience Platform. Con questa implementazione, Journey Optimizer B2B edition e Marketo Engage non si trovano sullo stesso sistema o archivio dati. Journey Optimizer B2B edition riceve i dati da Experience Platform. Tuttavia, continua a fare affidamento su adesioni a Marketo Engage e su alcune funzionalità di back-end, come la consegna e-mail, per il provisioning e la configurazione del sistema.
...
<tbody>
<tr>
<td colspan="2"><strong>Configurazioni XDM standard</strong>: configura gli schemi Profilo individuale XDM e Account aziendale XDM.</td>
<td></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="Casella di controllo"/></td>
...
<tr>
<td colspan="2"><strong>Schemi relazionali</strong>: selezionare campi XDM relazionali (oggetto personalizzato molti-a-uno account).</td>
<td></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="Casella di controllo"/></td>
...
<tr>
<td colspan="2">Configurazione del canale <strong>Pagine di destinazione</strong> per Journey Optimizer B2B edition.</td>
<td></td>
</tr>
<tr>
<td><img src="../assets/do-not-localize/icon-checkbox.svg" width="25" alt="Casella di controllo"/></td>
...
<td><a href="./admin/configure-channels-landing-pages.md">Ulteriori informazioni</a></td>
</tr>
<tr>
