...
1. Seleziona la scheda _Stili_ a destra e fai clic su **[!UICONTROL Aggiungi CSS personalizzato]**.
   ...
   ![Accedere agli stili del corpo](../../user/content/assets/email-body-styles.png){width="800" zoomable="yes"}
...
1. Immetti il codice CSS nell’editor.
   ...
   ![Inserisci CSS personalizzato nell&#39;editor](../../user/content/assets/content-design-add-custom-css.png){width="450"}
...
1. Fai clic su **[!UICONTROL Salva]** per salvare il file CSS personalizzato.
   ...
   ![CSS personalizzato applicato al contenuto](../../user/content/assets/email-body-custom-css-applied.png){width="600" zoomable="yes"}
