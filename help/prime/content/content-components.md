...
description: 'Progetta e-mail, pagine di destinazione e frammenti con componenti di contenuto: aggiungi pulsanti, testo, immagini, moduli e contenitori in Journey Optimizer B2B Prime.'
...
Quando si progetta contenuto per e-mail, pagine di destinazione, modelli e frammenti visivi, utilizzare [!UICONTROL Componenti contenuto] per aggiungere elementi di progettazione visiva.

Puoi aggiungere tutti i componenti di contenuto necessari all&#39;interno di uno o più [componenti struttura](./structure-components.md), che definiscono il layout.

## Libreria dei contenuti

Nella sezione **[!UICONTROL Contents]** della libreria dei componenti sono visualizzati i componenti di contenuto disponibili:
...
![Barra degli strumenti del componente contenuto](../../user/assets/do-not-localize/toolbar-content.png){width="450"}
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-text-styles.png" alt="Modifica stile testo, strumento"></td>
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-horizontal-alignment.png" alt="Strumento Allineamento orizzontale"></td>
...
<table>
    ...
    <tr>
        <td><img width="120px" src="../../user/assets/do-not-localize/toolbar-button-create-list.png" alt="Strumento Crea elenco"></td>
...
<table>
    ...
    <tr>
        <td><img width="60px" src="../../user/assets/do-not-localize/toolbar-button-set-heading.png" alt="Imposta strumento intestazione"></td>
...
<table>
    ...
    <tr>
        <td><img width="60px" src="../../user/assets/do-not-localize/toolbar-button-font-size.png" alt="Strumento Dimensione carattere"></td>
...
<table>
    ...
    <tr>
        <td><img width="200px" src="../../user/assets/do-not-localize/toolbar-button-font-color.png" alt="Strumento Colore carattere"></td>
...
<table>
    ...
    <tr>
        <td><img width="200px" src="../../user/assets/do-not-localize/toolbar-button-insert-link.png" alt="Inserisci strumento collegamento"></td>
...
<table>
    ...
    <tr>
        <td><img width="80px" src="../../user/assets/do-not-localize/toolbar-button-remove-link.png" alt="Rimuovi strumento collegamento"></td>
...
| ---- | ---- | ----- |
| ![Aggiungere la personalizzazione](../../user/assets/do-not-localize/toolbar-button-add-personalization.png){width="40"} | Aggiungere personalizzazione | Utilizza l’editor di personalizzazione per inserire i token di personalizzazione nel contenuto del componente. [Ulteriori informazioni](./email-authoring.md#personalize-content) |
| ![Mostra il codice sorgente](../../user/assets/do-not-localize/toolbar-button-show-source-code.png){width="40"} | Mostra il codice sorgente | Visualizza il codice sorgente HTML per il componente in una finestra a comparsa di sola lettura. <br/>![Mostra codice HTML](../../user/content/assets/content-components-show-source-code.png){width="200"} |
...
1. Nella libreria **[!UICONTROL Componenti]**, afferra l&#39;_handle di trascinamento_ ![Handle di trascinamento](../../assets/do-not-localize/icon-drag-handle.svg) per il componente contenuto desiderato, quindi trascinalo sui componenti struttura.
   ...
   ![Trascina il componente contenuto nel componente struttura](../../user/content/assets/content-components-drag.png){width="600" zoomable="yes"}

1. Regola la visualizzazione del componente utilizzando le schede **[!UICONTROL Impostazioni]** e **[!UICONTROL Stili]** a destra oppure la barra degli strumenti di contesto visualizzata nell&#39;area di lavoro.

   Ad esempio, puoi modificare lo stile del testo, la spaziatura interna o il margine del componente.

   ![Definire le impostazioni e gli stili per il componente contenuto](../../user/content/assets/content-components-settings-styles.png){width="600" zoomable="yes"}
...
![Opzioni di visualizzazione per il componente contenuto](../../user/content/assets/content-components-display-options.png){width="400" zoomable="yes"}
...
![Stili dei componenti di contenuto contenitore](../../user/content/assets/content-components-container.png){width="600" zoomable="yes"}
...
![Componente pulsante visualizzato con barra degli strumenti](../../user/content/assets/content-components-button.png){width="500" zoomable="yes"}
...
1. Imposta **[!UICONTROL Tipo]** per il collegamento:
   ...
   * **[!UICONTROL Collegamento esterno]** - Scegliere questo tipo per utilizzare un URL standard come destinazione del collegamento.
     ...
     In **[!UICONTROL Url]**, immettere l&#39;URL per la destinazione del collegamento. Fai clic sull&#39;icona _Personalizza_ ( ![Icona Personalizza](../../user/assets/do-not-localize/icon-personalize.svg) ) per utilizzare un token di personalizzazione come parametro nell&#39;URL.

     ![Definisci un collegamento esterno per un componente pulsante](../../user/content/assets/component-button-link-options-external.png){width="200"}
   ...
   * **Pagina di destinazione** - Scegliere questo tipo per selezionare una pagina di destinazione pubblicata nell&#39;istanza di Marketo Engage connessa <!-- Journey Optimizer B2B Edition (_Beta_) or -->.
     ...
     Per l&#39;opzione **[!UICONTROL Pagina di destinazione]**, selezionare la pagina di destinazione pubblicata. Fai clic sull&#39;icona _Seleziona pagina_ ( ![Mostra icona collegamenti](../../user/assets/do-not-localize/icon-landing-page-select.svg) ) e [seleziona la pagina di destinazione pubblicata](./landing-pages.md#link-to-landing-page).

     ![Definisci un collegamento a una pagina di destinazione per un componente pulsante](../../user/content/assets/component-button-link-options-landing-page.png){width="200"}
...
1. Per **[!UICONTROL Target]**, scegliere la modalità di reindirizzamento della destinazione collegata dall&#39;e-mail o dalla pagina:
...
* **[!UICONTROL Larghezza]** - Utilizza l&#39;interruttore per impostare la larghezza in pixel o in percentuale.
  ...
  ![Definire lo stile delle linee per un componente divisore](../../user/content/assets/component-divider-line-options.png){width="250"}
...
1. Selezionare il componente nell&#39;area di lavoro e fare clic sull&#39;icona _Mostra codice sorgente_ nella barra degli strumenti.
   ...
   ![Apri l&#39;editor di codice per aggiungere HTML](../../user/content/assets/content-components-html-show-code.png){width="450"}

1. Incolla il HTML nella casella di testo e fai clic su **[!UICONTROL Salva]**.

   ![Finestra di dialogo Modifica HTML](../../user/content/assets/content-components-html-edit-dialog.png){width="600" zoomable="yes"}
...
![Componente immagine visualizzato con barra degli strumenti](../../user/content/assets/content-components-image.png){width="400" zoomable="yes"}

#### Aggiungi la risorsa immagine {#add-image-asset}

Scegli un metodo per aggiungere la risorsa immagine:

* **[!UICONTROL Seleziona risorsa]** - Scegli questo tipo per sfogliare e selezionare una risorsa immagine dalla libreria Assets [!DNL Journey Optimizer B2B Prime].

  ![Sfoglia le risorse immagini disponibili](./assets/dam-assets-internal-image-selected.png){width="700" zoomable="yes"}
...
* **[!UICONTROL Importa file multimediali]** - Scegliere questo tipo per selezionare un file dal sistema e importarlo nella libreria di risorse [!DNL Journey Optimizer B2B Prime].
  ...
  ![Importa un file di immagine nella libreria di risorse](../../user/content/assets/email-designer-image-upload.png){width="450"}
...
![Impostazioni immagine](./assets/dam-assets-image-settings.png){width="250"}
...
1. Imposta **[!UICONTROL Tipo]** per il collegamento:
   ...
   * **[!UICONTROL Collegamento esterno]** - Scegliere questo tipo per utilizzare un URL standard come destinazione del collegamento.
     ...
     ![Definisci un collegamento esterno per un componente immagine](../../user/content/assets/component-button-link-options-external.png){width="250"}

   * **Pagina di destinazione** - Scegliere questo tipo per selezionare una pagina di destinazione pubblicata nell&#39;istanza di Marketo Engage connessa <!-- Journey Optimizer B2B Edition (_Beta_) or -->.

     Per l&#39;opzione **[!UICONTROL Pagina di destinazione]**, selezionare la pagina di destinazione pubblicata. Fai clic sull&#39;icona _Seleziona pagina_ ( ![Mostra icona collegamenti](../../user/assets/do-not-localize/icon-landing-page-select.svg) ) e [seleziona la pagina di destinazione pubblicata](./landing-pages.md#link-to-landing-page).

     ![Definisci un collegamento a una pagina di destinazione per un componente immagine](../../user/content/assets/component-button-link-options-landing-page.png){width="250"}

1. Per **[!UICONTROL Label]**, immettere facoltativamente il testo descrittivo per il collegamento dell&#39;immagine.
...
* **[!UICONTROL Source]** - Se desideri utilizzare una tua immagine invece di quella predefinita, scegli una risorsa immagine. Puoi selezionare un’immagine dalla libreria di Assets o importare un file di immagine dal sistema. Per informazioni dettagliate sulla selezione e l&#39;importazione delle risorse immagine, consultare [Informazioni sul componente immagine](#add-the-image-asset).
* **[!UICONTROL Testo alt]** - Immettere il testo alt per l&#39;immagine visualizzata.

![Impostazioni per il tipo di social media espanso](./assets/content-components-social-settings-for-type.png){width="250"}
...
1. Se si desidera ignorare il tipo di **[!UICONTROL completamento]** predefinito per il modulo, modificare l&#39;impostazione in base ai requisiti della pagina o del modello.
   ...
   * **[!UICONTROL Pagina di destinazione]** - Scegli questa opzione per selezionare una pagina di destinazione di [!DNL Journey Optimizer B2B Prime] o Marketo Engage come follow-up.
